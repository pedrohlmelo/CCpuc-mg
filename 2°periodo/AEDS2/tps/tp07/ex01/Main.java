...
class Game {
    ...
    /*public void imprimir() {
        System.out.println(id + " " + name + " " + releaseDate + " " + estimatedOwners + " " + price);
    }*/
}
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (FileWriter writer = new FileWriter("889841_arvoreBinaria.txt")) { // Substitua 'matricula' pelo seu número

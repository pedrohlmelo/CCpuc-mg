...
class Fila{
    ...
    //Meotodo para o primeiro print com o (R)
    public void MostrarJogoRemovido(Game game){
    ...
    public Game remover(){
      ...
      Game elemento = primeiro.elemento;
      tmp.prox = null;
      tmp = null;
      MostrarJogoRemovido(elemento);
      return elemento;
    }
    //Mostrar
    public void mostrar(){
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(int i =0; i < qtd; i++){
            ...
            switch(ordem[i]){
                case "I":
                id = sc.nextInt();
                fila.Inserir(GameporID(id, todosOsGames));
                break;
